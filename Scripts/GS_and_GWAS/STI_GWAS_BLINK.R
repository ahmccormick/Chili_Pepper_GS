...
#source("/home/ahmccorm/kantar_koastore/anna/WorldVeg_Capsicum/STI_GWAS/gapit_functions.txt") #saved to 
...
#  OUTPUT FOLDER 
out_base  <- "~/R/WorldVeg_Capsicum/STI_GWAS/BLINK/"
...
write.csv(gwas_log_df,
          file = file.path(out_base, "STI_GWAS_BLINK_BLUEadjusted_log.csv"),
          row.names = FALSE)
