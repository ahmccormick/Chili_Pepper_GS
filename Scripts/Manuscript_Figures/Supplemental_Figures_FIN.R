...
p<- ggboxplot(df_long, x = "timepoint", y = "value",
...
ggsave(
  filename = "/Users/annamccormick/R/World_Veg_Project/Figures/Figure_S1_climate.pdf",
  plot = p,
  width = 12,
  height = 10,
  units = "in"
...
########################################################################################################################
# Required preface for the marker effect changes for Figure B and 2D
########################################################################################################################
...
####################################################################################################################################################################
#Figure 73 trait prediction accuracies for control timepoint in the global collection.
#########################################################################################################
...
####################################################################################################################################################################
#Figure. 73 trait prediction accuracies for heat stress #1 timepoint in the global collection.
...
####################################################################################################################################################################
#Figure. 73 trait prediction accuracies for heat stress #2 timepoint in the global collection.
...
####################################################################################################################################################################
#Figure. Global results for the 17 traits with prediction accuracies above 0.5 for rrBLUP.
...
####################################################################################################################################################################
#Figure. 23 quality trait prediction accuracies for chili core collection (18 traits over 0.5).
...
####################################################################################################################################################################
#Figure. 23 quality trait prediction accuracies for chili global 10k collection (17 traits over 0.5).
##########################################
#McLeod Phenotype data - 23 traits (for n=329 lines)
##########################################
#Downloaded pheno data from 
...
####################################################################################################################################################################
################################################################################################
# Figure A – Climate vs Quality GEBV correlations
################################################################################################
library(tidyverse)
library(pheatmap)
library(ggfortify)
...
####################################################################################################################################################################
#Figure. Agronomic trait GEBV distributions in core and global collections.
